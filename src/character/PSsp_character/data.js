...
const sort = {
    PSsp_character_celebrity: ['PSsp_character_celebrity', '<span style="color:#22a5f1;font-family:xingkai;font-size:24px">群英荟萃</span>'],
    PSsp_character_meme: ['PSsp_character_meme', '<span style="color:#f4326f;font-family:xingkai;font-size:24px">梗系列</span>'],
}
...
export const data = {
    PSsp_jiugeshadiao: {
        ...
        intro: "由“九个鲨雕”设计<br>九个鲨雕，创群之初就已加入，目前是Q群里最高头衔的存在，曾声称已跟作者本人姓。",
        skills: {
            PSsp_jiuzhuan: {
                trigger: {
                    player: "phaseBegin"
